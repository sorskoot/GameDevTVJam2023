...
Following these guidelines should help create an engaging and balanced experience for your players.
...
#### Day 2 -  Core Gameplay Mechanics [X]
...
#### Day 7 - Finalizing main game loop [x]
...
1. Apply last-minute polish if needed based on test feedback.
1. Compile final build of the game and submit it for consideration in the game jam event.
1. Set up the Itch.io page.
